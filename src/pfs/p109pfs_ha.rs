...
pub type R = crate::R<P109pfsHaSpec>;
#[doc = "Register `P109PFS_HA` writer"]
pub type W = crate::W<P109pfsHaSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P109pfsHaSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P109pfsHaSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P109pfsHaSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P109pfsHaSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P109pfsHaSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<P109pfsHaSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Failing"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<P109pfsHaSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P109pfsHaSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P109pfsHaSpec> {
        AselW::new(self, 15)
    }
}
#[doc = "P109 Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p109pfs_ha::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p109pfs_ha::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P109pfsHaSpec;
impl crate::RegisterSpec for P109pfsHaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p109pfs_ha::R`](R) reader structure"]
impl crate::Readable for P109pfsHaSpec {}
#[doc = "`write(|w| ..)` method takes [`p109pfs_ha::W`](W) writer structure"]
impl crate::Writable for P109pfsHaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P109PFS_HA to value 0"]
impl crate::Resettable for P109pfsHaSpec {}
