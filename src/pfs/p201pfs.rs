...
pub type R = crate::R<P201pfsSpec>;
#[doc = "Register `P201PFS` writer"]
pub type W = crate::W<P201pfsSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P201pfsSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P201pfsSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P201pfsSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P201pfsSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Drive Strength Control Register"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P201pfsSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<P201pfsSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Falling"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<P201pfsSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P201pfsSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P201pfsSpec> {
        AselW::new(self, 15)
    }
    #[doc = "Bit 16 - Port Mode Control"]
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P201pfsSpec> {
        PmrW::new(self, 16)
    }
    #[doc = "Bits 24:28 - Port Function Select These bits select the peripheral function. For individual pin functions, see the setting table."]
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P201pfsSpec> {
        PselW::new(self, 24)
    }
}
#[doc = "P201 Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p201pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p201pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P201pfsSpec;
impl crate::RegisterSpec for P201pfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p201pfs::R`](R) reader structure"]
impl crate::Readable for P201pfsSpec {}
#[doc = "`write(|w| ..)` method takes [`p201pfs::W`](W) writer structure"]
impl crate::Writable for P201pfsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P201PFS to value 0x10"]
impl crate::Resettable for P201pfsSpec {
