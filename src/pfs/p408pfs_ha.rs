...
pub type R = crate::R<P408pfsHaSpec>;
#[doc = "Register `P408PFS_HA` writer"]
pub type W = crate::W<P408pfsHaSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P408pfsHaSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P408pfsHaSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P408pfsHaSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P408pfsHaSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Drive Strength Control Register"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P408pfsHaSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 11 - Drive Strength Control Register"]
    #[inline(always)]
    pub fn dscr1(&mut self) -> Dscr1W<P408pfsHaSpec> {
        Dscr1W::new(self, 11)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<P408pfsHaSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Falling"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<P408pfsHaSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P408pfsHaSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P408pfsHaSpec> {
        AselW::new(self, 15)
    }
}
#[doc = "P408 Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p408pfs_ha::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p408pfs_ha::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P408pfsHaSpec;
impl crate::RegisterSpec for P408pfsHaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p408pfs_ha::R`](R) reader structure"]
impl crate::Readable for P408pfsHaSpec {}
#[doc = "`write(|w| ..)` method takes [`p408pfs_ha::W`](W) writer structure"]
impl crate::Writable for P408pfsHaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P408PFS_HA to value 0"]
impl crate::Resettable for P408pfsHaSpec {}
