...
pub type R = crate::R<P108pfsHaSpec>;
#[doc = "Register `P108PFS_HA` writer"]
pub type W = crate::W<P108pfsHaSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P108pfsHaSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P108pfsHaSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P108pfsHaSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P108pfsHaSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P108pfsHaSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<P108pfsHaSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Failing"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<P108pfsHaSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P108pfsHaSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P108pfsHaSpec> {
        AselW::new(self, 15)
    }
}
#[doc = "P108 Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p108pfs_ha::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p108pfs_ha::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P108pfsHaSpec;
impl crate::RegisterSpec for P108pfsHaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p108pfs_ha::R`](R) reader structure"]
impl crate::Readable for P108pfsHaSpec {}
#[doc = "`write(|w| ..)` method takes [`p108pfs_ha::W`](W) writer structure"]
impl crate::Writable for P108pfsHaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P108PFS_HA to value 0x10"]
impl crate::Resettable for P108pfsHaSpec {
