...
pub type R = crate::R<P000pfsSpec>;
#[doc = "Register `P000PFS` writer"]
pub type W = crate::W<P000pfsSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P000pfsSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P000pfsSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P000pfsSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P000pfsSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P000pfsSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P000pfsSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P000pfsSpec> {
        AselW::new(self, 15)
    }
    #[doc = "Bit 16 - Port Mode Control"]
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P000pfsSpec> {
        PmrW::new(self, 16)
    }
    #[doc = "Bits 24:28 - Port Function Select These bits select the peripheral function. For individual pin functions, see the MPC table"]
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P000pfsSpec> {
        PselW::new(self, 24)
    }
}
#[doc = "P00%s Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p000pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p000pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P000pfsSpec;
impl crate::RegisterSpec for P000pfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p000pfs::R`](R) reader structure"]
impl crate::Readable for P000pfsSpec {}
#[doc = "`write(|w| ..)` method takes [`p000pfs::W`](W) writer structure"]
impl crate::Writable for P000pfsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P000PFS to value 0"]
impl crate::Resettable for P000pfsSpec {}
