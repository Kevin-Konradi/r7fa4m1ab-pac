...
impl W {
    #[doc = "Bit 0 - mailbox 0 Interrupt Enable"]
    #[inline(always)]
    pub fn mb0(&mut self) -> Mb0W<MierSpec> {
        Mb0W::new(self, 0)
    }
    #[doc = "Bit 1 - mailbox 1 Interrupt Enable"]
    #[inline(always)]
    pub fn mb1(&mut self) -> Mb1W<MierSpec> {
        Mb1W::new(self, 1)
    }
    #[doc = "Bit 2 - mailbox 2 Interrupt Enable"]
    #[inline(always)]
    pub fn mb2(&mut self) -> Mb2W<MierSpec> {
        Mb2W::new(self, 2)
    }
    #[doc = "Bit 3 - mailbox 3 Interrupt Enable"]
    #[inline(always)]
    pub fn mb3(&mut self) -> Mb3W<MierSpec> {
        Mb3W::new(self, 3)
    }
    #[doc = "Bit 4 - mailbox 4 Interrupt Enable"]
    #[inline(always)]
    pub fn mb4(&mut self) -> Mb4W<MierSpec> {
        Mb4W::new(self, 4)
    }
    #[doc = "Bit 5 - mailbox 5 Interrupt Enable"]
    #[inline(always)]
    pub fn mb5(&mut self) -> Mb5W<MierSpec> {
        Mb5W::new(self, 5)
    }
    #[doc = "Bit 6 - mailbox 6 Interrupt Enable"]
    #[inline(always)]
    pub fn mb6(&mut self) -> Mb6W<MierSpec> {
        Mb6W::new(self, 6)
    }
    #[doc = "Bit 7 - mailbox 7 Interrupt Enable"]
    #[inline(always)]
    pub fn mb7(&mut self) -> Mb7W<MierSpec> {
        Mb7W::new(self, 7)
    }
    #[doc = "Bit 8 - mailbox 8 Interrupt Enable"]
    #[inline(always)]
    pub fn mb8(&mut self) -> Mb8W<MierSpec> {
        Mb8W::new(self, 8)
    }
    #[doc = "Bit 9 - mailbox 9 Interrupt Enable"]
    #[inline(always)]
    pub fn mb9(&mut self) -> Mb9W<MierSpec> {
        Mb9W::new(self, 9)
    }
    #[doc = "Bit 10 - mailbox 10 Interrupt Enable"]
    #[inline(always)]
    pub fn mb10(&mut self) -> Mb10W<MierSpec> {
        Mb10W::new(self, 10)
    }
    #[doc = "Bit 11 - mailbox 11 Interrupt Enable"]
    #[inline(always)]
    pub fn mb11(&mut self) -> Mb11W<MierSpec> {
        Mb11W::new(self, 11)
    }
    #[doc = "Bit 12 - mailbox 12 Interrupt Enable"]
    #[inline(always)]
    pub fn mb12(&mut self) -> Mb12W<MierSpec> {
        Mb12W::new(self, 12)
    }
    #[doc = "Bit 13 - mailbox 13 Interrupt Enable"]
    #[inline(always)]
    pub fn mb13(&mut self) -> Mb13W<MierSpec> {
        Mb13W::new(self, 13)
    }
    #[doc = "Bit 14 - mailbox 14 Interrupt Enable"]
    #[inline(always)]
    pub fn mb14(&mut self) -> Mb14W<MierSpec> {
        Mb14W::new(self, 14)
    }
    #[doc = "Bit 15 - mailbox 15 Interrupt Enable"]
    #[inline(always)]
    pub fn mb15(&mut self) -> Mb15W<MierSpec> {
        Mb15W::new(self, 15)
    }
    #[doc = "Bit 16 - mailbox 16 Interrupt Enable"]
    #[inline(always)]
    pub fn mb16(&mut self) -> Mb16W<MierSpec> {
        Mb16W::new(self, 16)
    }
    #[doc = "Bit 17 - mailbox 17 Interrupt Enable"]
    #[inline(always)]
    pub fn mb17(&mut self) -> Mb17W<MierSpec> {
        Mb17W::new(self, 17)
    }
    #[doc = "Bit 18 - mailbox 18 Interrupt Enable"]
    #[inline(always)]
    pub fn mb18(&mut self) -> Mb18W<MierSpec> {
        Mb18W::new(self, 18)
    }
    #[doc = "Bit 19 - mailbox 19 Interrupt Enable"]
    #[inline(always)]
    pub fn mb19(&mut self) -> Mb19W<MierSpec> {
        Mb19W::new(self, 19)
    }
    #[doc = "Bit 20 - mailbox 20 Interrupt Enable"]
    #[inline(always)]
    pub fn mb20(&mut self) -> Mb20W<MierSpec> {
        Mb20W::new(self, 20)
    }
    #[doc = "Bit 21 - mailbox 21 Interrupt Enable"]
    #[inline(always)]
    pub fn mb21(&mut self) -> Mb21W<MierSpec> {
        Mb21W::new(self, 21)
    }
    #[doc = "Bit 22 - mailbox 22 Interrupt Enable"]
    #[inline(always)]
    pub fn mb22(&mut self) -> Mb22W<MierSpec> {
        Mb22W::new(self, 22)
    }
    #[doc = "Bit 23 - mailbox 23 Interrupt Enable"]
    #[inline(always)]
    pub fn mb23(&mut self) -> Mb23W<MierSpec> {
        Mb23W::new(self, 23)
    }
    #[doc = "Bit 24 - mailbox 24 Interrupt Enable"]
    #[inline(always)]
    pub fn mb24(&mut self) -> Mb24W<MierSpec> {
        Mb24W::new(self, 24)
    }
    #[doc = "Bit 25 - mailbox 25 Interrupt Enable"]
    #[inline(always)]
    pub fn mb25(&mut self) -> Mb25W<MierSpec> {
        Mb25W::new(self, 25)
    }
    #[doc = "Bit 26 - mailbox 26 Interrupt Enable"]
    #[inline(always)]
    pub fn mb26(&mut self) -> Mb26W<MierSpec> {
        Mb26W::new(self, 26)
    }
    #[doc = "Bit 27 - mailbox 27 Interrupt Enable"]
    #[inline(always)]
    pub fn mb27(&mut self) -> Mb27W<MierSpec> {
        Mb27W::new(self, 27)
    }
    #[doc = "Bit 28 - mailbox 28 Interrupt Enable"]
    #[inline(always)]
    pub fn mb28(&mut self) -> Mb28W<MierSpec> {
        Mb28W::new(self, 28)
    }
    #[doc = "Bit 29 - mailbox 29 Interrupt Enable"]
    #[inline(always)]
    pub fn mb29(&mut self) -> Mb29W<MierSpec> {
        Mb29W::new(self, 29)
    }
    #[doc = "Bit 30 - mailbox 30 Interrupt Enable"]
    #[inline(always)]
    pub fn mb30(&mut self) -> Mb30W<MierSpec> {
        Mb30W::new(self, 30)
    }
    #[doc = "Bit 31 - mailbox 31 Interrupt Enable"]
    #[inline(always)]
    pub fn mb31(&mut self) -> Mb31W<MierSpec> {
        Mb31W::new(self, 31)
    }
}
