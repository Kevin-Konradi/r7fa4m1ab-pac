...
pub type R = crate::R<D1fifoselSpec>;
#[doc = "Register `D1FIFOSEL` writer"]
pub type W = crate::W<D1fifoselSpec>;
...
impl W {
    #[doc = "Bits 0:3 - FIFO Port Access Pipe Specification"]
    #[inline(always)]
    pub fn curpipe(&mut self) -> CurpipeW<D1fifoselSpec> {
        CurpipeW::new(self, 0)
    }
    #[doc = "Bit 8 - FIFO Port Endian Control"]
    #[inline(always)]
    pub fn bigend(&mut self) -> BigendW<D1fifoselSpec> {
        BigendW::new(self, 8)
    }
    #[doc = "Bit 10 - FIFO Port Access Bit Width"]
    #[inline(always)]
    pub fn mbw(&mut self) -> MbwW<D1fifoselSpec> {
        MbwW::new(self, 10)
    }
    #[doc = "Bit 12 - DMA/DTC Transfer Request Enable"]
    #[inline(always)]
    pub fn dreqe(&mut self) -> DreqeW<D1fifoselSpec> {
        DreqeW::new(self, 12)
    }
    #[doc = "Bit 13 - Auto Buffer Memory Clear Mode Accessed after Specified Pipe Data is Read"]
    #[inline(always)]
    pub fn dclrm(&mut self) -> DclrmW<D1fifoselSpec> {
        DclrmW::new(self, 13)
    }
    #[doc = "Bit 14 - Buffer Pointer Rewind"]
    #[inline(always)]
    pub fn rew(&mut self) -> RewW<D1fifoselSpec> {
        RewW::new(self, 14)
    }
    #[doc = "Bit 15 - Read Count Mode"]
    #[inline(always)]
    pub fn rcnt(&mut self) -> RcntW<D1fifoselSpec> {
        RcntW::new(self, 15)
    }
}
#[doc = "D1FIFO Port Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`d1fifosel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`d1fifosel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct D1fifoselSpec;
impl crate::RegisterSpec for D1fifoselSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`d1fifosel::R`](R) reader structure"]
impl crate::Readable for D1fifoselSpec {}
#[doc = "`write(|w| ..)` method takes [`d1fifosel::W`](W) writer structure"]
impl crate::Writable for D1fifoselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets D1FIFOSEL to value 0"]
impl crate::Resettable for D1fifoselSpec {}
