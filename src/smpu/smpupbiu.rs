...
impl W {
    #[doc = "Bit 0 - CPU Read protection"]
    #[inline(always)]
    pub fn rpcpu(&mut self) -> RpcpuW<SmpupbiuSpec> {
        RpcpuW::new(self, 0)
    }
    #[doc = "Bit 1 - CPU Write protection"]
    #[inline(always)]
    pub fn wpcpu(&mut self) -> WpcpuW<SmpupbiuSpec> {
        WpcpuW::new(self, 1)
    }
    #[doc = "Bit 2 - Master Group A Read protection"]
    #[inline(always)]
    pub fn rpgrpa(&mut self) -> RpgrpaW<SmpupbiuSpec> {
        RpgrpaW::new(self, 2)
    }
    #[doc = "Bit 3 - Master Group A Write protection"]
    #[inline(always)]
    pub fn wpgrpa(&mut self) -> WpgrpaW<SmpupbiuSpec> {
        WpgrpaW::new(self, 3)
    }
}
