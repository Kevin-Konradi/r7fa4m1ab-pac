...
pub type R = crate::R<BusscntSpec>;
#[doc = "Register `BUSSCNT%s` writer"]
pub type W = crate::W<BusscntSpec>;
...
impl W {
    #[doc = "Bits 4:5 - Arbitration Method Specify the priority between groups"]
    #[inline(always)]
    pub fn arbmet(&mut self) -> ArbmetW<BusscntSpec> {
        ArbmetW::new(self, 4)
    }
}
...
pub struct BusscntSpec;
impl crate::RegisterSpec for BusscntSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`busscnt::R`](R) reader structure"]
impl crate::Readable for BusscntSpec {}
#[doc = "`write(|w| ..)` method takes [`busscnt::W`](W) writer structure"]
impl crate::Writable for BusscntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUSSCNT%s to value 0"]
impl crate::Resettable for BusscntSpec {}
